...
┣━━ 📂 assets/                              # README용 에셋
┃   ┗━━ 📂 readme/
┃       ┣━━ 📂 badges/dark|light/           # Built With 기술 스택 뱃지
┃       ┣━━ 🖼️ logo.png
┃       ┗━━ 🖼️ preview-home.png             # Preview 스크린샷
┣━━ 📂 MACTA-frontend/                      # React 클라이언트
┃   ┣━━ 📂 src/
┃   ┃   ┣━━ 📂 api/                         # Axios 클라이언트 · auction/auth/user
┃   ┃   ┣━━ 📂 components/                  # layout · common · UI 프리미티브
┃   ┃   ┣━━ 📂 hooks/                       # 경매 목록 등 커스텀 훅
┃   ┃   ┣━━ 📂 pages/                       # 홈·상세·입찰·결제·마이·알림 등
┃   ┃   ┣━━ 📂 store/                       # Zustand (auth · server time)
┃   ┃   ┣━━ 📂 styles/                      # 전역 스타일
┃   ┃   ┣━━ 📂 utils/                       # 포맷 · 카테고리 · 이미지 · 라우트
┃   ┃   ┣━━ 📄 App.tsx                      # 라우팅 · 앱 셸
┃   ┃   ┗━━ 📄 main.tsx                     # 진입점
┃   ┣━━ 📄 Dockerfile
┃   ┣━━ 📄 nginx.conf
...
┃   ┃   ┣━━ 📂 event/ · 📂 listener/        # 경매·알림 이벤트
┃   ┃   ┣━━ 📂 exception/                   # 전역 · 비즈니스 예외
┃   ┃   ┣━━ 📂 global/                      # Security · JWT 등
...
┃   ┣━━ 📄 docker-compose.yml
┃   ┣━━ 📄 pom.xml
┃   ┗━━ 📄 .env.example                     # DB · JWT · Redis · S3 예시
┣━━ 📂 MACTA-infra/                         # AWS · Kubernetes · GitOps
┃   ┣━━ 📂 terraform/                       # VPC · EKS · WAF · RDS · S3 · ECR
┃   ┣━━ 📂 k8s/                             # backend · frontend · ingress · Redis
┃   ┣━━ 📂 argocd/                          # Application Manifest
┃   ┗━━ 📂 scripts/                         # IRSA 등 운영 스크립트
┗━━ 📄 README.md
```
